...
def write_ret_flow_details(self, filename, gs_dict, info_dict):
    with open(filename, 'w') as f:
        for item in item_types['7']:
            item_num = item
            item_id = 'L' + item_num
            items = list(self.ui.scene.items())
            for block in items:
...
def write_divers_details(self, filename, gs_dict, info_dict):
    with open(filename, 'w') as f:
        for item in item_types['8']:
            item_num = item
            item_id = 'L' + item_num
            items = list(self.ui.scene.items())
            for block in items:
...
def write_spillflow_details(self, filename, gs_dict, info_dict):
    with open(filename, 'w') as f:
        for item in item_types['9']:
            item_num = item
            item_id = 'L' + item_num
            items = list(self.ui.scene.items())
            for block in items:
...
def write_ibasin_flow_details(self, filename, gs_dict, info_dict):
    with open(filename, 'w') as f:
        for item in item_types['10']:
            item_num = item
            item_id = 'L' + item_num
            items = list(self.ui.scene.items())
            for block in items:
...
def write_demand_details(self, filename, gs_dict, info_dict):
    with open(filename, 'w') as f:
        for item in item_types['11']:
            item_num = item
            item_id = 'L' + item_num
            items = list(self.ui.scene.items())
            for block in items:
