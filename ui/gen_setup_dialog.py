...
class Ui_genSet_dialog(object):
    def setupUi(self, genSet_dialog):
        ...
        self.restrictions_input = QtWidgets.QLineEdit(
            self.gen_setup_left_frame)
        sizePolicy = QtWidgets.QSizePolicy(
            QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.restrictions_input.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.time_step_input.sizePolicy().hasHeightForWidth())
        ...
        spacerItem2 = QtWidgets.QSpacerItem(
            40, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_16.addItem(spacerItem2, 0, 4, 1, 1)
        self.gridLayout_15.addWidget(self.gen_setup_left_frame, 0, 0, 1, 1)
        self.empty_frame_2 = QtWidgets.QFrame(self.gen_setup_box)
        ...
        self.gridLayout_15.addWidget(self.empty_frame_2, 0, 1, 1, 1)
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.type_sim_combo.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.year_input.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.ensem_input.sizePolicy().hasHeightForWidth())
        ...
        self.empty_frame_1 = QtWidgets.QFrame(self.simulationbox)
        ...
        self.gridLayout_17.addWidget(self.empty_frame_1, 0, 1, 1, 1)
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.analysis_option.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.year_sim_input.sizePolicy().hasHeightForWidth())
        ...
        self.adaptive_button.toggled['bool'].connect(
            self.adaptive_box.setVisible)
        QtCore.QMetaObject.connectSlotsByName(genSet_dialog)
        genSet_dialog.setTabOrder(
            self.time_step_input, self.restrictions_input)
    ...
    def retranslateUi(self, genSet_dialog):
        ...
        genSet_dialog.setWindowTitle(
            _translate("genSet_dialog", "General Setup"))
        self.gen_setup_box.setTitle(
            _translate("genSet_dialog", "General Setup"))
        self.time_step.setText(_translate(
            "genSet_dialog", "Number of time steps"))
        self.restrictions_level.setText(_translate(
            "genSet_dialog", "Number of restictions level"))
        self.simulationbox.setTitle(_translate("genSet_dialog", "Simulation"))
        self.type_sim_combo.setItemText(
            0, _translate("genSet_dialog", "Climatology"))
        self.type_sim_combo.setItemText(
            1, _translate("genSet_dialog", "Forecast"))
        self.type_sim_combo.setItemText(
            2, _translate("genSet_dialog", "Zero Flow"))
        self.type_of_sim.setText(_translate(
            "genSet_dialog", "Type of Simulation"))
        self.num_years.setText(_translate("genSet_dialog", "Number of years"))
        self.num_ensembles.setText(_translate(
            "genSet_dialog", "Number of ensembles"))
        self.userDescription.setTabText(self.userDescription.indexOf(
            self.userDescription_tab), _translate("genSet_dialog", "User Description"))
        self.analysis_option.setTitle(
            _translate("genSet_dialog", "Select Option"))
        self.retro_button.setText(_translate(
            "genSet_dialog", "Restrospective Analysis"))
        self.adaptive_button.setText(_translate(
            "genSet_dialog", "Adaptive Forecasts"))
        self.adaptive_box.setTitle(_translate(
            "genSet_dialog", "Adaptive Forecasts"))
        self.num_years_sim.setText(_translate(
            "genSet_dialog", "Number of years of simulations"))
        ...
        self.userDescription.setTabText(self.userDescription.indexOf(
            self.forecast_tab), _translate("genSet_dialog", "Forecast"))
