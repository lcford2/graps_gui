...
class Ui_watershed_dialog(object):
    def setupUi(self, watershed_dialog):
        ...
        self.inflows_label.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignHCenter)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.forecast_file_box.sizePolicy().hasHeightForWidth())
        ...
        self.forecast_labe.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignHCenter)
        ...
        self.select_forecast_file = QtWidgets.QPushButton(self.forecast_file_box)
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        watershed_dialog.setTabOrder(self.drain_input, self.select_forecast_file)
        watershed_dialog.setTabOrder(self.select_forecast_file, self.forecast_file_input)
        watershed_dialog.setTabOrder(self.forecast_file_input, self.select_inflow_file)
    ...
    def retranslateUi(self, watershed_dialog):
        ...
        self.inflows_file_box.setTitle(_translate("watershed_dialog", "Observed Inflows File"))
        self.inflows_label.setText(_translate("watershed_dialog", "<html><head/><body><p>Observed Inflows</p></body></html>"))
        self.select_inflow_file.setText(_translate("watershed_dialog", "Select"))
        self.forecast_file_box.setTitle(_translate("watershed_dialog", "Forecast File"))
        self.forecast_labe.setText(_translate("watershed_dialog", "<html><head/><body><p>Forecast</p></body></html>"))
        self.select_forecast_file.setText(_translate("watershed_dialog", "Select"))
