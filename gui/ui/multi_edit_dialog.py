...
class Ui_multi_edit_dialog(object):
    def setupUi(self, multi_edit_dialog):
        ...
        multi_edit_dialog.resize(446, 427)
        ...
        self.block_type_combo.addItem("")
        self.block_type_combo.addItem("")
        self.block_type_combo.setItemText(5, "")
        self.gridLayout.addWidget(self.block_type_combo, 0, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.attribute_selector, 1, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.attribute_editor, 0, 0, 2, 1)
