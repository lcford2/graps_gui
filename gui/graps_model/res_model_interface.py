...
class ReservoirModel(object):
    ...
    def GetTemoaNames(self):
        ...
        for key in self.res_names.keys():
    ...
    def CreateSimulArguments(self):
        ...
        self.hydro_benefit = self.ArrayType2(
            *[1.0 for i in range(int(self.nparam))])
    ...
    def MakeOutputContainers(self, run_name):
        ...
        print(self.temoa_names)
        for b_id, value in zip(block_ids, values):
            print(b_id, self.temoa_names.get(b_id, None))
    ...
    def InitializeModel(self):
        self.DeclareInitArgumentTypes
        self.Initialize
        self.GetResNames
        self.GetTemoaNames
        self.DeclareSimulArgumentTypes

    def Simulate(self):
        self.CreateSimulArguments
        self.Simulate
        # self..MakeOutputContainers(run_name)
...
if __name__ == '__main__':
    ...
    in_path = os.path.join("..", "model_runs", args.scenario) + "/"
    out_path = os.path.join("..", "model_runs", args.scenario, "output") + "/"
