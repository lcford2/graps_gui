...
integer itype,nres,nuser,nfnode,nsink,nwatershed,ndir_inflows,nret_inflows
integer ndiversion,nspill_flow,nnatural_flow,ninterbasin_flow,ndemand_release
integer ntime,nensem, ncons,iblock,ntotal_vertices,isimul_block,nsimul_block,iflow_set,nres_level, lukes_ncons
...
integer, allocatable :: id_output(:), cons_id(:), res_ids_for_spdef(:), user_id(:)
